...
document.write("<script src='"+path+"src/zardvark/display/counter.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/display/hero.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/display/particle.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/display/tileback.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/display/tilesprite.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/game.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/acid.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/apple.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/block.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/cloud.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/coin.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/item.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/ladder.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/spike.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/spring.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/water.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/items/win.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/levels/level.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/levels/level0.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/levels/level1.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/scenes/credits.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/scenes/home.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/scenes/map.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/scenes/preload.js' language='javascript'><\/script>");
document.write("<script src='"+path+"src/zardvark/scenes/score.js' language='javascript'><\/script>");
